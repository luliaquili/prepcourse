...
const { getLastPathSegment } = require("@11ty/eleventy/src/TemplatePath");
...
// [10, 10, 16, 12] promedio (sumar array / array largo)
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  if (arguments.length === 0 ) return 0; if ( arguments.lenght === 1 ) return arguments.length ;  
