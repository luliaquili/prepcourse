...
function obtenerMayor(x, y) {
  ...
  // Tu código:
  if (x<y) return y; if (x>y) return x; if (x===y) return x || y;
}
...
function conection(status) {
  ...
  if (status===1) return "Online" ; if (status===2) return "Away"; else return "Offline"
}
...
function saludo(idioma) {
  ...
  // Tu código:
  if (idioma==="aleman") return "Guten Tag!"; else if(idioma==="mandarin") return "Ni Hao!"; else if (idioma==="ingles")return "Hello!";
   else return "Hola!";
}
